...
const elements = {
  ...
  blackboardLoginFeedback: $("blackboard-login-feedback"),
  blackboardLoginForm: $("blackboard-login-form"),
  blackboardMeta: $("blackboard-meta"),
  blackboardOpenPage: $("blackboard-open-page"),
  blackboardPassword: $("blackboard-password"),
  blackboardRememberPassword: $("blackboard-remember-password"),
  ...
  blackboardUsername: $("blackboard-username"),
