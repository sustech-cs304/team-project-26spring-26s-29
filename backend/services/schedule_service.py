...
class ScheduleService:
    ...
    def initialize_database(self, db_path: str | None = None) -> str:
        return self._repository.initialize_database(db_path)

    def list_schedules(self, db_path: str | None = None, *, include_cancelled: bool = True) -> list[ScheduleEvent]:
        return self._repository.list_schedule_events(db_path, include_cancelled=include_cancelled)

    def list_schedules_in_range(self, range_start: str | datetime, range_end: str | datetime, db_path: str | None = None, *, include_cancelled: bool = True) -> list[ScheduleEvent]:
        return self._repository.list_schedule_events_in_range(range_start, range_end, db_path, include_cancelled=include_cancelled)

    def get_schedule(self, event_id: int, db_path: str | None = None) -> ScheduleEvent | None:
    ...
    def delete_schedule(self, event_id: int, db_path: str | None = None) -> bool:
        return self._repository.delete_schedule_event(event_id, db_path)

    def clear_schedules(self, db_path: str | None = None) -> int:
